                ...
                if(user.equals("admin") && password.equals("password@123") && role.equals("administrator"))
                    {
                        ...
                        RequestDispatcher dispatch= getServletContext().getRequestDispatcher("/WelcomeAdminPage.jsp");
                        ...
                        if(user.equals("user1") && password.equals("user@123") && role.equals("customer"))
                        ...
                        else
                            {
                                ...
                                out.println("</head>");
                                out.println("<body>");
                                out.println("table border='0' bgcolor='#000080' align='top'vwidth='100%' style='height:100px'>");
                                out.println("<tr>");
                                ...
                                out.println("<img src='Images/.png' width='180' height='120' align='right'/>");
                                out.println("</td>");
                                out.println("</tr>");
                                out.println("<table>");
                                out.println("<font style='font-family: 'Aria; Rounded MT Bold;' sie='+2' color='red'>Invalid User Credentials!!");
                            }
                    }
        }
    }
